      ...
      <div className="mx-auto w-full max-w-[88rem] px-6 py-16 sm:px-8 lg:px-14 lg:py-20">
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="lg:col-span-5">
            <FadeUp>
              <a href="#hero" className="group inline-flex" aria-label="evadde — back to top">
                <Logo />
              </a>
          ...
          <nav aria-label="Footer" className="grid gap-10 sm:grid-cols-3 lg:col-span-6 lg:col-start-7">
            ...
            <div data-footer-col>
              ...
              <ul className="mt-5 flex flex-col gap-3 text-[0.9375rem] text-navy/75">
                <li>
                  <a href={contact.phoneHref} className="link-underline hover:text-navy">
              ...
              <h2 className="mt-8 text-eyebrow font-medium uppercase text-faint">Follow</h2>
              <ul className="mt-5 flex flex-col gap-3">
                {socials.map((social) => (
                  <li key={social.label}>
                    <a
