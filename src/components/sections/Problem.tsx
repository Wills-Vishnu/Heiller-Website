    ...
    >
        ...
        <FadeUp delay={0.2}>
          <p className="mt-16 max-w-[46ch] text-sm leading-relaxed text-faint">
            Industry-wide figures, not heiller-specific claims. Sources: denial and
            rework rates from RCM industry benchmarking data; administrative waste
            estimate from Shrank et al., JAMA (2019).
          </p>
        </FadeUp>
      </div>
    </section>
