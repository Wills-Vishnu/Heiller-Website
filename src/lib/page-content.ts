...
export const aboutPage = {
  ...
  lede: 'evadde was built by people who spent years inside revenue cycle operations, and got tired of watching good clinical work get written off over a missing modifier.',
} as const;
