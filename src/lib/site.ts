...
export const company = {
  ...
  description:
    'heiller is a revenue cycle management partner for hospitals, clinics and physician groups. We unify coding, claims, denials and collections into one intelligent, auditable system.',
  founded: '2019',
} as const;
...
export const socials = [
  { label: 'LinkedIn', href: 'https://www.linkedin.com/', handle: '/company/heiller' },
  { label: 'Instagram', href: 'https://www.instagram.com/', handle: '@heiller' },
  { label: 'Discord', href: 'https://discord.com/', handle: 'heiller' },
] as const;
...
export const heroHeadline = {
  ...
  lede: 'heiller unifies coding, claims, denials and collections into one intelligent system — so your team stops chasing payments and starts predicting them.',
 ...
 * communities". heiller is a healthcare revenue cycle management company
