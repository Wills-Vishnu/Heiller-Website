...
export const auditProcessItems = [
  {
    id: 'reports',
    number: '01',
    title: 'Share existing reports',
    body: 'Send the reporting you already run. Nothing new has to be produced for the review.',
  },
  {
    id: 'metrics',
    number: '02',
    title: 'Review core metrics',
    body: 'We work through the same measures the benchmarks above use, and find where your figures come apart from them.',
  },
  {
    id: 'priorities',
    number: '03',
    title: 'Receive priorities',
    body: 'A written list of where revenue is being lost, ordered by what is worth recovering first.',
  },
  {
    id: 'findings',
    number: '04',
    title: 'Discuss the findings',
    body: 'We walk the list through with you and agree what you would want handled first.',
  },
] as const;
