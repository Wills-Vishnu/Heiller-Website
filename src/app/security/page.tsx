...
export const metadata: Metadata = {
  ...
  description:
    'How heiller protects protected health information: attestations, the PHI lifecycle, control families, subprocessors and incident response.',
  alternates: { canonical: '/security' },
  openGraph: {
    title: 'Security & compliance — heiller',
    description:
  ...
  return (
    <>
      ...
      <section className={`${WRAP} scroll-mt-24 py-[11vh]`}>
        ...
        <p className="mt-8 max-w-[64ch] text-[0.9375rem] leading-relaxed text-muted">
          Our team also uses general-purpose AI tools — ChatGPT, Claude — for
          drafting and research, on standard consumer accounts rather than a
          business tier with a signed BAA. No client claims data or PHI is
          entered into either tool. They aren&rsquo;t listed above because no
          PHI reaches them, and therefore no business-associate relationship
          exists to disclose.
        </p>
      </section>
